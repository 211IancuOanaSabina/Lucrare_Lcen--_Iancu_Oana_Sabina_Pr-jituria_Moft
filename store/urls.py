...
urlpatterns = [
    ...
    path('store/profile/<str:id>', views.profile, name= "profile"),
    path('presentation/profile/<str:id>', views.profile, name= "profile"),
    path('recipes/profile/<str:id>', views.profile, name= "profile"),
    path('special/profile/<str:id>', views.profile, name= "profile"),
    path('cart/profile/<str:id>', views.profile, name= "profile"),
    path('description/profile/<str:id>', views.profile, name= "profile"),
    ...
    path('admin/', views.error403, name="error403")
]
