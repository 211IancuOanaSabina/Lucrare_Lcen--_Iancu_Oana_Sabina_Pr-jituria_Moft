...
class Customer(models.Model):
    ...
    password1 = models.CharField(max_length=301, null=True)
    password2 = models.CharField(max_length=301, null=True)
...
class ReviewProduct(models.Model):
    ...
    reviewProd = models.OneToOneField(Product, on_delete=models.CASCADE, null = True, blank = True)
